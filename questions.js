...
//       // Extract the label from the file path (e.g., "cat.mp3" -> "Cat")
//       var optionLabel = option.split('/').pop().replace('.mp3', '');
//       optionLabel = capitalizeFirstLetter(optionLabel);
